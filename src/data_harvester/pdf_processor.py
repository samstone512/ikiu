...
# --- PROFESSIONAL FIX: Added explicit poppler path to make the project portable ---
...
def convert_pdfs_to_images(pdf_dir: Path, image_dir: Path, specific_files: Optional[List[Path]] = None):
    ...
    This version includes a direct path to the poppler library to avoid system PATH issues.
    """
    logging.info("--- Starting PDF to Image Conversion Process ---")

    # --- IMPORTANT: Set the path to your extracted poppler's 'bin' folder here ---
    # لطفا این آدرس را با آدرس دقیق پوشه bin در کامپیوتر خودتان جایگزین کنید
    # مثال: r"D:\poppler\poppler-24.02.0-win-64\bin"
    poppler_path_local = r"D:\Library\poppler-25.07.0\Library\bin"
    ...
    for pdf_path in pdf_files:
        try:
            ...
            # --- PROFESSIONAL FIX APPLIED HERE ---
            # We pass the poppler_path directly to the function
