...
def load_donut_model():
    ...
    if DONUT_MODEL is None:
        ...
        try:
            # This specific model is fine-tuned for document parsing tasks.
            ...
            logging.info(f"Donut model loaded successfully and moved to {DEVICE}.")
...
def extract_text_with_donut(image_path: Path) -> str:
    ...
    try:
        ...
        # The task prompt for Donut is crucial. For general transcription, we can use the document parsing prompt.
